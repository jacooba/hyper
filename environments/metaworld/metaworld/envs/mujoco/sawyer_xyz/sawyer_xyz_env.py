...
from environments.metaworld.metaworld.envs.mujoco.mujoco_env import MujocoEnv, _assert_task_is_set
...
class SawyerXYZEnv(SawyerMocapBase, metaclass=abc.ABCMeta):
    ...
    def _get_state_rand_vec(self):
        if self._freeze_rand_vec:
            ...
            # ADDED BY LUISA: replacing this to be thread-safe
            rand_vec = np.array(random.uniform(self._random_reset_space.low, self._random_reset_space.high))
