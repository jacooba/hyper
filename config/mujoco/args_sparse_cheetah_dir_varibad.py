...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='HalfCheetahDirSparseTen-v0', help='environment to train on')
    ...
    parser.add_argument('--intrinsic_rew_for_hyperstate', type=boolean_argument, default=False, help='reward bonus on (s, b)')
    ...
    parser.add_argument('--intrinsic_rew_for_vae_loss', type=boolean_argument, default=False)
