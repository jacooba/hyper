...
def get_args(rest_args):
    ...
    parser.add_argument('--encoder_enc_type', type=str_or_none, default="gru", help='type of encoder in Aggregator, e.g. gru, transition, amu, None')
    parser.add_argument('--encoder_skip_type', type=str_or_none, default=None, help='type of skip connection in Aggregator, e.g. enc, None')
    parser.add_argument('--encoder_agg_type', type=str_or_none, default=None, help='type of aggregation in Aggregator, e.g. max, avg, gauss')
