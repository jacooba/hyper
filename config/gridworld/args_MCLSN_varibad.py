...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='MC-LSN-v0', help='environment to train on')
    parser.add_argument('--num_frames', type=int, default=60e6, help='number of frames to train')
