...
def get_args(rest_args):
    ...
    # env
    parser.add_argument('--env_name', default='SemicircleEnv-v0', help='environment to train on')
    ...
    parser.add_argument('--policy_num_steps', type=int, default=60, # 200
    ...
    parser.add_argument('--tbptt_stepsize', type=int_or_none, default=None, help='stepsize for truncated backpropagation through time; None uses maximum (horizon of BAMDP)')
    parser.add_argument('--vae_subsample_elbos', type=int, default=None, help='number of elbos to subsample')
    parser.add_argument('--vae_subsample_decodes', type=int, default=None, help='number of reconstruction terms to subsample')
